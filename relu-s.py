# 1 Hidden Layer Scikit-Learn Neural Network with ReLU Activation Function
...
if __name__ == '__main__':
    ...
    logistic = MLPClassifier(hidden_layer_sizes=(300,), activation='relu', solver='sgd', learning_rate_init=0.1, max_iter=1000).fit(Xtrn, ytrn)
    ...
    ax.set_title('Scikit-Learn Neural Network - ReLU Activation')
