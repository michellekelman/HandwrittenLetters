# 1 Hidden Layer Neural Network implementation with ReLU Activation Function
# Sources:
...
class NeuralNetwork():
    ...
    def backward(self, X, y, a1, a2):
        ...
        delta2 = error
        delta1 = np.matmul(self.w2.T, delta2)
        n = y.shape[1]
...
if __name__ == '__main__':
    ...
    ax.set_title('1 Hidden Layer - ReLU Activation')
